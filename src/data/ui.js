export const uiData = [
   {
      name: "stand",
      desc:
         "add your item and stand in line please :-) [ noodles, beer, eggs, fruit, ]",
      inputs: 1,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "list",
      desc:
         "add to the grocery list ( item + quantity) [ beer: 3, lettuce: 2, soap: 4, ]",
      inputs: 1,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      name: "construct",
      desc:
         'construct the sentence to your fitting. [My favorite beer is "___" , and I love it deeply.]',
      inputs: 1,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "remove numbers from the list using splice. 1, 2, 3, 4, 5, 6, 7, 8, 9",
      inputs: 2,
      type: "intermediate",
      typeNum: 200,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "give a minimun and maximun value and click run to generate a whole number between those values",
      inputs: 2,
      type: "intermediate",
      typeNum: 200,
      isFavorite: false,
   ...
   },
   {
      name: "lookUpProfile",
      desc:
         "Look at the list of name and properties. Find out someones profile by putting in a first name and then a property. NAMES: Tatsuro, Jim, Nat, Sante. PROPERTIES: lastName, number, likes",
      inputs: 2,
      type: "intermediate",
      typeNum: 200,
      isFavorite: false,
   ...
   },
   {
      name: "checkPositive",
      desc:
         "input an array of numbers to see if they contain all positive numbers.",
      inputs: 1,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "input a beer and it will sort it alphabetically within the previously used beer list",
      inputs: 1,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      name: "squareArray",
      desc:
         "input an array of numbers to have only the positive integers in that array squared",
      inputs: 1,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "get average rating of movies for the director inputed (either James Cameron or Christopher Nolan)",
      inputs: 1,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      name: "addWithConcat",
      desc:
         "add a beer of your preference to the end of this array of beer names. [kirin, corona, modelo, sapporo, pabst, stella]",
      inputs: 1,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "remove parts of the array of beer with the designated start and end using their index number as reference. [kirin, corona, modelo, sapporo, pabst, stella]",
      inputs: 2,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      name: "sliceArray",
      desc:
         "slice the array of animals in the designated start and end using their index number as reference. [ goat, dog, bird, rat, penguin, tiger, elephant, ]",
      inputs: 2,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "filter out the numbers that are divisble by the input. [2, 4, 7, 23, 64, 534, 7, 45, 265]",
      inputs: 1,
      type: "functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      name: "sliceAndSplice",
      desc:
         'copy each element of the first array into the second array, in order, using the input of "index" as the placement at which to add',
      inputs: 3,
      type: "algorithm",
      typeNum: 400,
      isFavorite: false,
   ...
   },
   {
      name: "titleCase",
      desc:
         "Return the inputed string with the first letter of each word capitalized. Make sure the rest of the word is in lower case",
      inputs: 1,
      type: "algorithm",
      typeNum: 400,
      isFavorite: false,
   ...
   },
   {
      name: "largestOfFour",
      desc:
         "return an array consisting of the largest number from each sub-array. example : [[4, 5, 1, 3], [13, 27, 18, 26], [32, 35, 37, 39], [1000, 1001, 857, 1]]",
      inputs: 1,
      type: "algorithm",
      typeNum: 400,
      isFavorite: false,
